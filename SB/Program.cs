...
namespace SB
{
    class Program
    {
        static void Rand(ref int x, ref int y, ref bool rotate)
        {
        ...
        static void Zone(int Id, int Alivecells, ref bool rotate, Table field, int x, int y)
        {
            if (Id == 14)
            {
        ...
        static void AutoDisposal(Ship ship, int Alivecells, ref bool rotate, Table field, int Id)
        {
            bool flag = true;
            int x = 0, y = 0;
            do
        ...
        static void Main(string[] args)
        {
            ...
            if (ButtonAuto == true)
            {
                ...
                AutoDisposal(Ship5, Alivecells, ref rotate, table, 13);

                Alivecells = 4;
                Ship Ship22 = Factory22.Create(14, rotate, x, y);
                AutoDisposal(Ship22, Alivecells, ref rotate, table, 14);

                for (int i = 11; i < 13; i++)
                {
                    Alivecells = 4;
                    Ship Ship4 = Factory4.Create(i, rotate, x, y);
                    AutoDisposal(Ship4, Alivecells, ref rotate, table, i);
                ...
                for (int i = 9; i < 11; i++)
                {
                    ...
                    AutoDisposal(Ship3, Alivecells, ref rotate, table, i);
                ...
                for (int i = 6; i < 9; i++)
                {
                    ...
                    AutoDisposal(Ship2, Alivecells, ref rotate, table, i);
                ...
                for (int i = 1; i < 6; i++)
                {
                    ...
                    AutoDisposal(Ship1, Alivecells, ref rotate, table, i);
